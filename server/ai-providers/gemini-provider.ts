...
Be as accurate as possible with portion estimates and nutritional values. Use standard USDA nutritional values for basic, unprocessed foods. Only return the JSON object, no additional text.`;
